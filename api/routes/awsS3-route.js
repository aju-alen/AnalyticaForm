...
import { uploadToAWSImage, fetchImageDetails, uploadToAWSPdf, fetchPdfDetails, uploadBrandLogo, viewPdf } from '../controllers/awsS3-controller.js';
...
router.get('/view-pdf', apiCallLimiter, viewPdf);
