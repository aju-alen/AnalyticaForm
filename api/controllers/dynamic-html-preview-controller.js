    ...
    try{
        ...
        res.send(`
            ...
            <head>
                ...
                <meta name="description" content="${survey.surveyDescription}" />
                
                <!-- Facebook Open Graph Tags -->
                <meta property="og:site_name" content="Dubai Analytica" />
                <meta property="og:type" content="website" />
                <meta property="og:title" content="${survey.surveyTitle}" />
                <meta property="og:description" content="${survey.surveyDescription}" />
                ...
                <meta name="twitter:description" content="${survey.surveyDescription}" />
